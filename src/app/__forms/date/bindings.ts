...
export const bindings = {
    '/date-picker':[{
      'input': function (event: any, formProperty?: FormProperty) {
        console.log('### input event target value: ', event.srcElement.value, event)
      },
      'change': function (event: any, formProperty?: FormProperty) {
        console.log('### change event target value: ', event.srcElement.value, 'prop:', formProperty.value, event)
      },
      'select': function (event: any, formProperty?: FormProperty) {
        console.log('### select event target value: ', event.srcElement.value, event)
      },
      /** 
