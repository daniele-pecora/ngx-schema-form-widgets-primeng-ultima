      ...
      for (const propertyKey in properties) {
        if (-1 === required.indexOf(propertyKey)) {
          ...
          propertyValue.widget.__info_property_optional =
            'The property \'__optional\' and this have been set automatically. See https://github.com/makinacorpus/angular2-schema-form/issues/175'
        }
      }
    }
  }
      ...
      if (value === '' && schema.widget && schema.widget.__optional) {
        ...
        if (newSchema.oneOf) {
          ...
          newSchema.oneOf.unshift({
            description: "Hidden null value option - The property '__optional' and this have been set automatically. See https://github.com/makinacorpus/angular2-schema-form/issues/175",
            enum: [null]
          })
        }
